...
export class LiveClient {
    ...
    preAuth(): Promise<PreAuthResponse> {
    ...
    async liveAuthenticate(email: string, password: string): Promise<LiveAuthenticateResponse> {
        const preAuthResponse = await this.preAuth();
...
export const live = LiveClient.instance;
